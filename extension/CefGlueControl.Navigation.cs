...
public void ShowDeveloperTools() { var w = CefWindowInfo.Create(); w.SetAsPopup(IntPtr.Zero, "DevTools"); _browserHost?.ShowDevTools(w, new PopupCefClient(), new CefBrowserSettings(), new CefPoint()); }
