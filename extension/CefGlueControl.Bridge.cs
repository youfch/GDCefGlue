...
public partial class CefGlueControl
{
    ...
    private void SendNativeObjectCallResult(int cid, object r, string err)
    {
        ...
        using (var a = m.Arguments) { a.SetInt(0, cid); if (err != null) { a.SetBool(1, false); a.SetString(2, null); a.SetString(3, err); } else { a.SetBool(1, true); try { a.SetString(2, r?.ToString()); } catch { a.SetString(2, null); } a.SetString(3, null); } }
